class EncrypterView {
    ...
    constructor(main, object) { //je krijgt de main mee in de constructor
        ...
        this.htmlElement.classList.add("view"); //Hier wordt een "view" class toegevoegd voor de styling van het "article" element.

        this.main = main;   //this main is main dus je defined het weer in deze scope.
    ...
    changeBody(encryptedText) {
        this.body.changeBody(encryptedText); // Hier wordt de methode "changeBody" aangeroepen op het "body" object.
    }
