class Header {
    ...
    constructor(view, headingText) {  //je maakt een constructor met de view en headingtext
        ...
        this.htmlElement.classList.add("view__header"); //je voegt een class voor styling toe aan de header
        ...
        this.htmlElement.appendChild(this.headingHtmlElement);  //je voegt de h1 toe aan de header.
        this.view = view;   //je geeft aan dat view, view is in de scope
        this.view.main.app.renderer.render(this.htmlElement, this.view.htmlElement);    //hier geef je aan wat je gaat renderen.     
    }
}